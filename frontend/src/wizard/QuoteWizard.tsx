  ...
  return (
    <div className="quote-wizard-shell min-h-dvh overflow-x-hidden bg-slate-50 text-slate-900">
      ...
      <div className="mx-auto max-w-7xl px-4 pt-2 pb-28 md:px-8 md:py-6">
        <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm md:rounded-[28px] md:p-6">
      ...
      <div className="md:hidden fixed inset-x-0 bottom-0 z-50 border-t border-slate-200 bg-white/96 backdrop-blur pb-3">
