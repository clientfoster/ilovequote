          ...
          <div className="flex items-center gap-4">
            ...
            {logo ? (
              ...
              <div className="w-16 h-16 bg-slate-50 border border-slate-200 rounded-[12px] flex items-center justify-center text-[#1D4ED8] shrink-0 font-extrabold text-2xl shadow-xs">
                {companyName ? companyName.charAt(0).toUpperCase() : <Building2 className="w-8 h-8 opacity-80" />}
              </div>
            )}
            ...
            <div>
              ...
              {tagline && <p className="text-xs text-slate-400 font-medium tracking-wide mt-0.5">Business Profile Preview</p>}
            </div>
          </div>
          ...
          <div className="text-left sm:text-right shrink-0">
            {formData.businessSlug && (
              <span className="text-[10px] font-mono tracking-wider font-extrabold text-[#1D4ED8] uppercase block">
                /portfolio/{formData.businessSlug}
              </span>
            )}
            {formData.businessSlug && (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
          ...
          <div className="space-y-3.5">
            ...
            <div className="flex items-start gap-2 text-xs text-slate-600">
              ...
              {fullAddress && <span className="font-semibold leading-relaxed text-slate-800">{fullAddress}</span>}
            </div>
          </div>
